...
namespace MoEmbed.Providers
{
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://www.worldeventtrading.com/" />.
    /// </summary>
    public sealed partial class WorldeventtradingMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://worldeventtrading\.com/predictions/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "worldeventtrading.com";
            yield return "www.worldeventtrading.com";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://www.worldeventtrading.com/api/oembed", request);
    }
    ...
    {
        private static readonly Regex _UriPattern = new Regex(@"^(http://ted\.com/talks/|https://ted\.com/talks/|http://www\.ted\.com/talks/|https://www\.ted\.com/talks/|https://embed\.ted\.com/talks/)");
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://livecodes.io/" />.
    /// </summary>
    public sealed partial class LiveCodesMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^(https://livecodes\.io/|https://livecodes\.io/\?|https://.*\.livecodes\.io/|https://.*\.livecodes\.io/\?)");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "livecodes.io";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://livecodes.io/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://risky.biz/" />.
    /// </summary>
    public sealed partial class RiskybizMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://risky\.biz/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "risky.biz";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://risky.biz/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://embed.orizn.app" />.
    /// </summary>
    public sealed partial class OriznMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://embed\.orizn\.app/frame/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "embed.orizn.app";
            yield return "orizn.app";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://embed.orizn.app/api/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://www.scibly.com/" />.
    /// </summary>
    public sealed partial class SciblyMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^(https://app\.scibly\.com/public/courses/|https://app\.scibly\.com/embed/courses/|https://app\.scibly\.com/en/public/courses/|https://app\.scibly\.com/en/embed/courses/|https://app\.scibly\.com/de/public/courses/|https://app\.scibly\.com/de/embed/courses/)");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "app.scibly.com";
            yield return "scibly.com";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://app.scibly.com/api/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://app.typecel.io" />.
    /// </summary>
    public sealed partial class TypecelMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://app\.typecel\.io/.*/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "app.typecel.io";
            yield return "typecel.io";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://app.typecel.io/api/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://keystonepractice.co" />.
    /// </summary>
    public sealed partial class KeystonePracticeMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://keystonepractice\.co/tools/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "keystonepractice.co";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://keystonepractice.co/api/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://stem.fm" />.
    /// </summary>
    public sealed partial class StemfmMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^(https://stem\.fm/session/|https://www\.stem\.fm/session/|https://stem\.fm/s/|https://www\.stem\.fm/s/)");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "stem.fm";
            yield return "www.stem.fm";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://www.stem.fm/oembed", request);
    }

    /// <summary>
    /// Handles oEmbed request for <see href="https://app.parler.com/" />.
    /// </summary>
    public sealed partial class ParlerMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://app\.parler\.com/post/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "app.parler.com";
            yield return "parler.com";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://app.parler.com/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://www.amcharts.com/" />.
    /// </summary>
    public sealed partial class AmchartsLiveEditorMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://chart\.amcharts\.com/.*/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "chart.amcharts.com";
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://live.amcharts.com/api/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://tlexdr.com/" />.
    /// </summary>
    public sealed partial class TLexDRMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://tlexdr\.com/episode/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "tlexdr.com";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://tlexdr.com/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://streetartcities.com/" />.
    /// </summary>
    public sealed partial class StreetartcitiesMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://streetartcities\.com/markers/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "streetartcities.com";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://oembed.streetartcities.com/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://haus.fazen.co/" />.
    /// </summary>
    public sealed partial class FazenhausMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://haus\.fazen\.co/embed/music/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "haus.fazen.co";
            yield return "fazen.co";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://haus.fazen.co/api/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://dcalculators.com/" />.
    /// </summary>
    public sealed partial class DcalculatorsMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://dcalculators\.com/.*/.*/.*/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "dcalculators.com";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://dcalculators.com/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://clipform.io/" />.
    /// </summary>
    public sealed partial class ClipformMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://clipform\.io/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "clipform.io";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://api.clipform.io/v1/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://mirame360.com" />.
    /// </summary>
    public sealed partial class Mirame360MetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^(https://mirame360\.com/embed/|https://mirame360\.com/embed/tour/|https://mirame360\.com/video/url/|https://mirame360\.com/tour/|https://mirame360\.com/user/.*/media/)");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "mirame360.com";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://mirame360.com/api/oembed/", request);
    }

    /// <summary>
    /// Handles oEmbed request for <see href="https://jawafdehi.org" />.
    /// </summary>
    public sealed partial class JawafdehiMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://jawafdehi\.org/case/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "jawafdehi.org";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://api.jawafdehi.org/oembed/", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://coloringmonster.com" />.
    /// </summary>
    public sealed partial class ColoringmonsterMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://coloringmonster\.com/coloring-page/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "coloringmonster.com";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://coloringmonster.com/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://skhema.com/" />.
    /// </summary>
    public sealed partial class SkhemaMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://skhema\.com/embed/e/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "skhema.com";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://skhema.com/api/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://nouncify.com/" />.
    /// </summary>
    public sealed partial class NouncifyMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^(https://nouncify\.com/i/|https://nouncify\.com/brand/|https://nouncify\.com/e/|https://sandbox\.nouncify\.com/i/|https://sandbox\.nouncify\.com/brand/|https://sandbox\.nouncify\.com/e/)");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "nouncify.com";
            yield return "sandbox.nouncify.com";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://nouncify.com/api/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://fritube.ch" />.
    /// </summary>
    public sealed partial class FritubeMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://fritube\.ch/v/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "fritube.ch";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://fritube.ch/services/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://vidlink.it" />.
    /// </summary>
    public sealed partial class VidLinkMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://vidlink\.it/videos/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "vidlink.it";
            yield return "www.vidlink.it";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://www.vidlink.it/api/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://everypage.co" />.
    /// </summary>
    public sealed partial class EverypageMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://everypage\.co/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "everypage.co";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://everypage.co/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://wppaste.com" />.
    /// </summary>
    public sealed partial class WPPasteMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://wppaste\.com/p/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "wppaste.com";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://wppaste.com/api/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://castle.xyz" />.
    /// </summary>
    public sealed partial class CastleMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://castle\.xyz/d/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "castle.xyz";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://castle.xyz/api/oembed", request);
    }
    ...
    {
        private static readonly Regex _UriPattern = new Regex(@"^(https://tegula\.io/m/|https://www\.tegula\.io/m/|https://tegula\.io/c/|https://www\.tegula\.io/c/|https://tegula\.io/cat\.html\?model=|https://www\.tegula\.io/cat\.html\?model=)");
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://carbonvoice.app/" />.
    /// </summary>
    public sealed partial class CarbonVoiceMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^(https://carbonvoice\.app/s/|https://carbonvoice\.app/m/|https://carbonvoice\.app/c/)");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "carbonvoice.app";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://carbonvoice.app/api/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://chanceindex.com" />.
    /// </summary>
    public sealed partial class ChanceindexMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://chanceindex\.com/odds/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "chanceindex.com";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://chanceindex.com/api/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://www.wikitolica.com" />.
    /// </summary>
    public sealed partial class WikitolicaMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://www\.wikitolica\.com/.*/.*/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "www.wikitolica.com";
            yield return "wikitolica.com";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://www.wikitolica.com/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://framerate.tv/" />.
    /// </summary>
    public sealed partial class FramerateMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://framerate\.tv/watch/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "framerate.tv";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://framerate.tv/api/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://www.pyzia.app/" />.
    /// </summary>
    public sealed partial class PyziaMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^(https://www\.pyzia\.app/dashboard\?|https://pyzia\.app/dashboard\?|https://www\.pyzia\.app/embed/chart\?|https://pyzia\.app/embed/chart\?)");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "www.pyzia.app";
            yield return "pyzia.app";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://www.pyzia.app/api/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://textexpander.com" />.
    /// </summary>
    public sealed partial class TextexpanderMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://rest-prod\.tenet\.textexpander\.com/share/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "rest-prod.tenet.textexpander.com";
            yield return "tenet.textexpander.com";
            yield return "textexpander.com";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://rest-prod.tenet.textexpander.com/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://synthcamp.net/" />.
    /// </summary>
    public sealed partial class SynthCampMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://synthcamp\.net/r/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "synthcamp.net";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://synthcamp.net/api/oembed", request);
    }
    ...
    /// <summary>
    /// Handles oEmbed request for <see href="https://www.justspin.cc/" />.
    /// </summary>
    public sealed partial class JustSpinMetadataProvider : OEmbedProxyMetadataProvider, IMetadataProvider
    {
        private static readonly Regex _UriPattern = new Regex(@"^https://www\.justspin\.cc/workouts/");

        /// <inheritdoc />
        public override IEnumerable<string> GetSupportedHostNames()
        {
            yield return "www.justspin.cc";
            yield return "justspin.cc";
        }
        ...
        /// <inheritdoc />
        protected override Uri GetProviderUriFor(ConsumerRequest request)
            => GetProviderUriCore("https://www.justspin.cc/api/oembed", request);
    }
    ...
    partial class OEmbedProxyMetadataProvider
    {
        internal static IEnumerable<Type> CreateKnownHandlerTypes()
        {
            ...
            yield return typeof(WorldeventtradingMetadataProvider);
            ...
            yield return typeof(LiveCodesMetadataProvider);
            yield return typeof(BlueskyMetadataProvider);
            yield return typeof(RiskybizMetadataProvider);
            ...
            yield return typeof(OriznMetadataProvider);
            ...
            yield return typeof(SciblyMetadataProvider);
            ...
            yield return typeof(TypecelMetadataProvider);
            ...
            yield return typeof(KeystonePracticeMetadataProvider);
            yield return typeof(ScreencastComMetadataProvider);
            yield return typeof(PodUPECMetadataProvider);
            yield return typeof(StemfmMetadataProvider);
            yield return typeof(ParlerMetadataProvider);
            ...
            yield return typeof(TLexDRMetadataProvider);
            ...
            yield return typeof(StreetartcitiesMetadataProvider);
            yield return typeof(FlatMetadataProvider);
            yield return typeof(FazenhausMetadataProvider);
            ...
            yield return typeof(DcalculatorsMetadataProvider);
            ...
            yield return typeof(ClipformMetadataProvider);
            ...
            yield return typeof(Mirame360MetadataProvider);
            yield return typeof(JawafdehiMetadataProvider);
            ...
            yield return typeof(ColoringmonsterMetadataProvider);
            ...
            yield return typeof(SkhemaMetadataProvider);
            ...
            yield return typeof(NouncifyMetadataProvider);
            ...
            yield return typeof(FritubeMetadataProvider);
            yield return typeof(SketchfabMetadataProvider);
            yield return typeof(VidLinkMetadataProvider);
            ...
            yield return typeof(EverypageMetadataProvider);
            yield return typeof(GmetriMetadataProvider);
            yield return typeof(PeertubeTvMetadataProvider);
            yield return typeof(WPPasteMetadataProvider);
            ...
            yield return typeof(CastleMetadataProvider);
            ...
            yield return typeof(CarbonVoiceMetadataProvider);
            ...
            yield return typeof(ChanceindexMetadataProvider);
            ...
            yield return typeof(WikitolicaMetadataProvider);
            ...
            yield return typeof(FramerateMetadataProvider);
            ...
            yield return typeof(PyziaMetadataProvider);
            ...
            yield return typeof(TextexpanderMetadataProvider);
            ...
            yield return typeof(SynthCampMetadataProvider);
            ...
            yield return typeof(JustSpinMetadataProvider);
